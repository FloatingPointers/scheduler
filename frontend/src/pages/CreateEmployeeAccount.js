...
function CreateEmployeeAccount() {
  ...
  return (
    <div className="flex flex-row justify-center items-center h-screen w-screen bg-bgSecondary text-xl">
      <form
        onSubmit={signupEmployee}
        className="border border-slate-300 bg-bgPrimary rounded-lg shadow-md p-8 flex flex-col gap-4"
      >
        ...
        <div className="inline-flex flex-col gap-2 w-full">
          ...
          <input
            ...
            maxLength={6}
            minLength={6}
            className="tracking-widest font-light border shadow-inner border-slate-300 rounded focus:border-slate-400 focus:outline-none p-1 w-full"
          />
        </div>
        ...
        <div className="inline-flex flex-col gap-1 w-full items-center">
          <button
            type="submit"
            className="w-full text-3xl font-semibold p-2 mt-2 bg-slate-600 border border-slate-300 text-white rounded hover:bg-slate-700"
          >
            Confirm
          </button>
          <p>or</p>
          <NavLink to="/" className="text-blue-500 hover:text-blue-400">
