        ...
        {tokenVerified ? (
          <form onSubmit={handleReset} className="flex flex-col gap-8">
            ...
            <div className="inline-flex flex-col gap-2 w-full">
              <button
                type="submit"
                className="w-full text-3xl bg-blue-500 text-white p-2 rounded-md hover:bg-blue-600 font-semibold transition-colors"
              >
                Reset Password
              </button>
              <NavLink
          ...
          <div className="flex flex-col gap-4 text-xl">
            <p>
              The link you used to reset your password is invalid or has
              expired, please return to the forgot password page to generate a
              new link
            </p>
            <div className="inline-flex flex-row items-center space-between w-full">
              <p
                ...
                className="w-full cursor-pointer text-blue-500 hover:text-blue-400"
              >
                Forgot Password
              </p>
              <NavLink
