        ...
        {sentRequest ? (
          <div className="flex flex-col gap-8 justify-center items-center">
            <h1 className="font-semibold text-3xl w-full">
              Reset Request Sent to {email}
            </h1>
            <p>Check your email for a link to reset your password</p>
            <NavLink
              to="/"
              className="text-blue-500 hover:text-blue-400 text-right w-full"
            >
              Back to Sign in
            </NavLink>
          ...
          <form onSubmit={handleResetRequest} className="flex flex-col gap-8">
            ...
            <div className="inline-flex flex-col gap-2 w-full">
              <button
                type="submit"
                className="w-full font-semibold text-3xl bg-blue-500 text-white p-2 rounded-md hover:bg-blue-600 transition-colors"
              >
                Request Password Reset
              </button>
              <NavLink
                to="/"
                className="text-blue-500 hover:text-blue-400 text-right"
              >
                Back to Sign in
              </NavLink>
            </div>
